...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00901 implements AnimationListener {
        C00901() {
        }
    ...
    class C00912 extends Animation {
        C00912() {
        }
    ...
    class C00923 extends Animation {
        C00923() {
        }
    ...
    class C00945 implements AnimationListener {
        C00945() {
        }
    ...
    class C00956 extends Animation {
        C00956() {
        }
    ...
    class C00967 extends Animation {
        C00967() {
        }
    ...
    class C00978 extends Animation {
        C00978() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C00901();
        this.mAnimateToCorrectPosition = new C00956();
        this.mAnimateToStartPosition = new C00967();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C00912();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C00923();
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mTarget != null) {
            ...
            this.mCircleView.measure(MeasureSpec.makeMeasureSpec(this.mCircleWidth, Declaration.MODULE_REFERENCE), MeasureSpec.makeMeasureSpec(this.mCircleHeight, Declaration.MODULE_REFERENCE));
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C00978();
