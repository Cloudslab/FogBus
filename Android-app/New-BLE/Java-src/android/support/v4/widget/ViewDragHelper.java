...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C00981();
    ...
    private final Runnable mSetIdleRunnable = new C00992();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C00981 implements Interpolator {
        C00981() {
        }
