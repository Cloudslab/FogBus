...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00641();
    ...
    private static final Interpolator sInterpolator = new C00652();
    ...
    private final Runnable mEndScrollRunnable = new C00663();
    ...
    static class C00641 implements Comparator<ItemInfo> {
        C00641() {
        }
    ...
    static class C00652 implements Interpolator {
        C00652() {
        }
    ...
    class C00663 implements Runnable {
        C00663() {
        }
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & DateTime.TIME_MASK;
