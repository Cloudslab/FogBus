        ...
        switch (moduleMethod.selector) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            obj6 = objArr[5];
                            try {
                                return Integer.valueOf($PcStringPrefixLengthCi(obj, length, intValue, obj3, intValue2, ((Number) obj6).intValue()));
                            } catch (ClassCastException e) {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            obj6 = objArr[5];
                            try {
                                return Integer.valueOf($PcStringSuffixLengthCi(obj, length, intValue, obj3, intValue2, ((Number) obj6).intValue()));
                            } catch (ClassCastException e2222) {
            ...
            case 237:
                ...
                while (true) {
                    length2--;
                    if (length2 < 0) {
                        return stringCompare$V(obj, obj7, obj2, obj3, obj4, objArr3);
                    }
            ...
            case 238:
                ...
                while (true) {
                    length2--;
                    if (length2 < 0) {
                        return stringCompareCi$V(obj, obj7, obj2, obj3, obj4, objArr3);
                    }
                    objArr3[length2] = objArr[length2 + 5];
                }
            case LispEscapeFormat.ESCAPE_NORMAL /*241*/:
            ...
            case 299:
                ...
                try {
                    ...
                    try {
                        ...
                        throw new WrongType(e3, "string-copy!", 3, obj);
                    }
                } catch (ClassCastException e2222222222) {
            ...
            case ErrorMessages.ERROR_TWITTER_BLANK_CONSUMER_KEY_OR_SECRET /*302*/:
                ...
                try {
                    ...
                    throw new WrongType(e32, "%string-copy!", 1, obj);
                }
            case ErrorMessages.ERROR_TWITTER_EXCEPTION /*303*/:
                obj2 = objArr[0];
                obj3 = objArr[1];
