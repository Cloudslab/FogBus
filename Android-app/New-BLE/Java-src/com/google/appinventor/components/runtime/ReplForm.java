...
public class ReplForm extends Form {
    ...
    class C02562 implements OnMenuItemClickListener {
        C02562() {
        }
    ...
    class C02573 implements OnMenuItemClickListener {
        C02573() {
        }
    ...
    public void addSettingsButton(Menu menu) {
        menu.add(0, 0, 3, "Settings").setOnMenuItemClickListener(new C02562()).setIcon(17301651);
    }

    public void addLogcatButton(Menu menu) {
        if (ReplApplication.isAcraActive()) {
            menu.add(0, 0, 4, "Send Error Report").setOnMenuItemClickListener(new C02573()).setIcon(17301642);
        }
    }
    ...
    protected void updateTitle() {
        ...
        if ("AppTheme.Light".equals(this.currentTheme)) {
            actionBar.setTitle(Html.fromHtml("<font color=\"black\">" + this.title + "</font>"));
            ImageViewUtil.setMenuButtonColor(this, -16777216);
            return;
        }
        actionBar.setTitle(this.title);
        ImageViewUtil.setMenuButtonColor(this, -1);
    }
