...
Master CPU, RAM and Cache usage are much lower in the Fog Only case due to elimination of Aneka overhead.
\begin{figure}[h]
\centering
\includegraphics[width=7cm]{g81} \ \ \ \ \ \ \ \ \ \ \       
\includegraphics[width=7cm]{g82}
\captionof{figure}{Master CPU Usage \%}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=7cm]{g91} \ \ \ \ \ \ \ \ \ \ \       
\includegraphics[width=7cm]{g92}
\captionof{figure}{Master RAM Usage \%}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=7cm]{g101} \ \ \ \ \ \ \ \ \ \ \       
\includegraphics[width=7cm]{g102}
\captionof{figure}{Master Cache Usage in $10^8$ bytes}
\end{figure}
